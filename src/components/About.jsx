export const About = () => {
  return (
    <section className="relative py-16 md:py-24 bg-white overflow-hidden reveal-on-scroll" id="about">
      <img
      ...
      <div className="page-container relative z-10">
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-[#A17339] font-medium text-sm md:text-base mb-3 reveal-on-scroll reveal-delay-1">About Us</p>

          <h2 className="mx-auto text-center mb-3 text-3xl sm:text-4xl md:text-5xl lg:text-[56px] font-normal leading-[1.05] text-black reveal-on-scroll reveal-delay-1">
          ...
          <p className="text-base sm:text-lg font-bold text-[#101010] mb-5 sm:mb-6 leading-snug reveal-on-scroll reveal-delay-2">
            We are committed to environmental conservation and climate-resilient economic development.
          </p>

          <p className="text-sm sm:text-[15px] text-[#555] leading-relaxed mb-8 sm:mb-10 reveal-on-scroll reveal-delay-2">
          ...
          <button className="inline-flex items-center gap-4 bg-[#0C9458] text-white py-3 px-7 sm:px-8 rounded-full font-semibold text-[15px] sm:text-[16px] mx-auto interactive-button reveal-on-scroll reveal-delay-3">
            About Us
