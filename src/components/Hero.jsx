...
export const Hero = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-white" id="home" ref={heroRef}>
      ...
      <div className="relative z-10 w-full pt-28 sm:pt-32 lg:pt-40 pb-16 sm:pb-20 min-h-[680px] sm:min-h-[760px] md:min-h-[860px] lg:min-h-[980px] flex flex-col justify-between">
