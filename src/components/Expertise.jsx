        ...
        <div className="bg-white rounded-t-[32px] md:rounded-t-[45px] pt-10 md:pt-12 lg:pt-14 pb-14 md:pb-16 lg:pb-20 px-4 sm:px-6 md:px-8 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12">
            <div className="lg:col-span-4 flex flex-col justify-center items-start">
              ...
              <button className="flex items-center gap-3 bg-[#0C9458] text-white rounded-full font-medium group transition-all hover:brightness-105 px-5 py-2.5 text-[15px] md:text-base">
            ...
            <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-0">
              {metrics.map((m, i) => (
                <div className="flex flex-col lg:border-l border-[#d0d0d0] lg:pl-8" key={i}>
