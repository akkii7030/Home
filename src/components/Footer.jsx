    ...
    <footer className="page-container reveal-on-scroll" id="footer">
      <div className="bg-[#f8f9fa] py-14 md:py-20 rounded-[32px] md:rounded-[60px] overflow-hidden relative px-5 sm:px-6 md:px-12 lg:px-16 xl:px-20 w-full">
        <div className="w-full">
          ...
          <div className="mb-16 md:mb-24 reveal-on-scroll reveal-delay-1">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 bg-white p-2 md:p-3 rounded-[22px] sm:rounded-[100px] shadow-lg max-w-[850px] border border-[#eee] transition-shadow hover:shadow-2xl">
              ...
              <button className="w-full sm:w-auto bg-[#0C9458] text-white py-3.5 md:py-4 px-8 md:px-12 rounded-full font-bold text-base md:text-lg transition-all hover:brightness-110 shadow-lg active:scale-95 interactive-button">Send</button>
            </div>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 mb-16 md:mb-20 pb-12 md:pb-20 border-b border-[#dee2e6] reveal-on-scroll reveal-delay-2">
            ...
            <div className="lg:col-span-1 flex flex-row lg:flex-col items-center justify-start lg:justify-start gap-5 pt-0 lg:pt-2">
              <button className="w-14 h-14 md:w-16 md:h-16 bg-[#25d366] text-white rounded-full flex items-center justify-center shadow-xl transition-transform hover:scale-110 group cursor-pointer z-10 interactive-button">
              ...
              <button className="w-14 h-14 md:w-16 md:h-16 bg-[#9e8450] text-white rounded-full flex items-center justify-center shadow-xl transition-transform hover:scale-110 group cursor-pointer z-10 interactive-button" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-7 reveal-on-scroll reveal-delay-3">
